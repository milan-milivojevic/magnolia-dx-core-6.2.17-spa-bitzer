  ...
  return (
    <div className={`App ${editMode}`}>
      ...
      <div className='pageContainer' ref={pageRef}>
        ...
        <footer>
          <div></div>
          <a className="footerLinks" href="mailto:dgmc@deutsche-glasfaser.de/" rel="noreferrer" target="_blank" role="button">Contact</a>
          <a className="footerLinks" href="https://www.deutsche-glasfaser.de/unternehmen/datenschutz/" rel="noreferrer" target="_blank" role="button">Privacy Policy</a>
