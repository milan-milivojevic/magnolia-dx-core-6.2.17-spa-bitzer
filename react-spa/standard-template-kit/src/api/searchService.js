import payload from './payloadBitzer.json'
import payloadSingleAsset from './payloadBitzerSingleAsset.json'
...
const updateSearchPayload = (sortingType, isAsc, offset, limit, query, selectedCategories, selectedSuffixes, selectedKeywords, selectedVdbs) => {
...
export const elasticSearchService = async (sortingType, isAsc, offset, limit, query, selectedCategories, selectedSuffixes, selectedKeywords, selectedVdbs) => {
  
  const updatedPayload = updateSearchPayload(sortingType, isAsc, offset, limit, query, selectedCategories, selectedSuffixes, selectedKeywords, selectedVdbs);
...
export const querySearch = async (sortingType, isAsc, offset, limit, query, selectedCategories, selectedSuffixes, selectedKeywords, selectedVdbs) => {
